...
// This is the original AgentSpot workflow list page (Option 2 — Agents + Workflow).
// It is intentionally kept separate so Option 3 changes never bleed into it.
"use client";
...
export default function WorkflowsListV2() {
