export type WorkflowRunStatus = "completed" | "running" | "failed" | null;
...
const SALES_WORKFLOWS: WorkflowsTabData = {
  mine: [
    { id: "w1", name: "Lead Qualification Flow",   description: "Scores, enriches, and routes inbound leads to the right rep",           color: "bg-violet-100",  emoji: "🎯", lastRunStatus: "completed", lastRunTime: "2 hrs ago",   isScheduled: true,  scheduleLabel: "Every weekday, 8 AM" },
    { id: "w2", name: "Post-Demo Follow-up",        description: "Pulls call notes and sends a personalised follow-up email after demos",  color: "bg-blue-100",    emoji: "✉️", lastRunStatus: "completed", lastRunTime: "Yesterday",   isScheduled: false },
    { id: "w3", name: "Proposal Generator",         description: "Creates custom proposals from templates with live deal data",            color: "bg-emerald-100", emoji: "📋", lastRunStatus: "failed",    lastRunTime: "3 hrs ago",   isScheduled: false },
    { id: "w4", name: "Deal Stage Updater",         description: "Listens to call transcripts and updates CRM stages automatically",       color: "bg-amber-100",   emoji: "💾", lastRunStatus: "running",   lastRunTime: "Just now",    isScheduled: true,  scheduleLabel: "Every hour" },
  ],
  shared: [
