...
const HR_DATA: PersonaDashboardData = {
  ...
  automationRuns: [
    { workflow: "Lead Qualification Flow", message: "Scored 48 new leads from the webinar — 12 flagged as high priority", time: "6 min ago", status: "success" },
    { workflow: "Post-Demo Follow-up", message: "Drafted 8 personalised follow-ups after yesterday's demos", time: "20 min ago", status: "success" },
    { workflow: "Deal Stage Updater", message: "Updating deal stages for 6 accounts from call transcripts...", time: "35 min ago", status: "running" },
    { workflow: "Proposal Generator", message: "Generated proposal for Acme Corp — $120K annual contract", time: "1 hr ago", status: "success" },
    { workflow: "Pipeline Review Prep", message: "Failed to fetch pipeline data from Salesforce — connection timeout", time: "2 hrs ago", status: "error" },
    { workflow: "Win Announcement", message: "Posted Stripe deal close ($85K ARR) to #sales-wins on Slack", time: "3 hrs ago", status: "success" },
    { workflow: "Contract Approval Flow", message: "Routed Figma MSA to legal and finance — awaiting sign-off", time: "4 hrs ago", status: "success" },
  ],
  suggestionChips: [
    "What can you do?",
